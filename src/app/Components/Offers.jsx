...
export default function Offers() {
  return (
    <div className="bg-white py-6 md:mt-33 mx-4 md:mx-0">
      {/* Desktop Section */}
      <motion.div
        className="hidden md:flex max-w-7xl mx-auto max-h-[300px]  bg-[#F2E7DB] rounded-2xl flex-col md:flex-row items-center justify-between px-8 relative"
      ...
      >
        ...
        <div className="absolute bottom-0 rounded-r-2xl right-0 rounded-b-2xl w-14 h-14 bg-[#245D51] rounded-t-full"></div>
        ...
        {/* Text Section */}
        <motion.div
          className="text-center md:text-left max-w-md space-y-5 z-10"
        ...
        >
          ...
          <motion.button
            className="bg-[#245D51] text-white px-6 py-3 rounded-sm font-semibold shadow hover:bg-[#1e4a41] transition"
        ...
        {/* Image Section */}
        <div className="flex justify-center h-[300px] "></div>
      </motion.div>

      {/* Mobile Section */}
      <motion.div
        className="md:hidden max-w-7xl mx-auto bg-[#F2E7DB] h-[300px] rounded-2xl px-6 py-10 text-center space-y-5 relative"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <div className="absolute -bottom-5 rounded-r-2xl right-0 rounded-b-2xl w-10 h-10 bg-[#245D51] rounded-t-full"></div>
        ...
        <motion.button
          className="bg-[#245D51] text-white px-6 py-3 mt-4 rounded-sm font-semibold shadow hover:bg-[#1e4a41] transition"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
          Subscribe Course
